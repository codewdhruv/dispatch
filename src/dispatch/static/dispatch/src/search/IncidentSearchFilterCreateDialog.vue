                      ...
                      <v-list-item>
                        <v-list-item-content>
                          <incident-type-combobox
                            :project="searchFilter.project"
                            v-model="searchFilter.filters.incident_type"
                          />
                        </v-list-item-content>
                      </v-list-item>
                      <v-list-item>
                        <v-list-item-content>
                          <incident-priority-combobox
                            :project="searchFilter.project"
                            v-model="searchFilter.filters.incident_priority"
                          />
                        </v-list-item-content>
                      </v-list-item>
                      <v-list-item>
                        <v-list-item-content>
                          <incident-status-multi-select v-model="searchFilter.filters.status" />
                        </v-list-item-content>
                      </v-list-item>
                      <v-list-item>
                        <v-list-item-content>
...
export default {
  name: "IncidentSearchFilterCreateDialog",
  props: {
    value: {
      type: Object,
      default: null,
  ...
  created() {
    ...
    this.$watch(
      (vm) => [
        vm.searchFilter.filters.incident_type,
        vm.searchFilter.filters.incident_priority,
